...
config.General.requestName     = 'HToAATo2TauHad2Photon_RHAnalyzer_fullTracks_%s'%Mass_tag
config.General.transferOutputs = True
config.General.transferLogs    = True

# CMS cfg file goes here:
config.JobType.pluginName  = 'Analysis'
config.JobType.psetName    = '/uscms/home/ereinhar/nobackup/CMSSW_13_0_13/src/Analyzer/RecHitAnalyzer/python/ConfFile_fullTracks_cfg.py'
...
# fullTracks mode requires AOD with extra collections (generalTracks kept)
