...
# Event Analysis
####
process.load('Analyzer.RecHitAnalyzer.hltanalysis_cfi')
process.load('Analyzer.RecHitAnalyzer.hltobject_cfi')
#process.load('Analyzer.RecHitAnalyzer.l1object_cfi')

from Analyzer.RecHitAnalyzer.hltobject_cfi import trigger_list_data
