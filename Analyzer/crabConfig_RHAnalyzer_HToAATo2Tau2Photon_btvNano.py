...
config.General.requestName     = 'HToAATo2TauHad2Photon_RHAnalyzer_btvNano_%s'%Mass_tag
config.General.transferOutputs = True
config.General.transferLogs    = True

# CMS cfg file goes here:
config.JobType.pluginName  = 'Analysis'
config.JobType.psetName    = '/uscms/home/ereinhar/nobackup/CMSSW_13_0_13/src/Analyzer/RecHitAnalyzer/python/ConfFile_btvNano_cfg.py'
...
# btvNano mode works on standard AOD (no extra collections needed)
